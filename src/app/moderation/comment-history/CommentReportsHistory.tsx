				...
				<div className='min-w-0 space-y-1'>
					<div className='font-medium text-[15px] leading-[1.45] text-foreground/90'>
						{r.comment ? (
							...
							<span className='text-red-600 dark:text-red-400'>{t('deletedComment')}</span>
						)}
					</div>
			...
			<div className='text-center text-[12px] font-medium'>
				<span
					className={cn(
						...
						r.status === 'IN_PROGRESS' && 'text-blue-700 dark:text-blue-400',
						r.status === 'IN_REVIEW' && 'text-violet-700 dark:text-violet-400',
