...
export function CropVideoModal({
	...
	return (
		<Dialog open={isOpen} onOpenChange={onOpenChange}>
			<DialogContent className='max-w-[700px] p-0 overflow-hidden border-border bg-card text-card-foreground rounded-2xl'>
				<div className='px-5 pt-5 pb-3 bg-muted/40'>
					<DialogHeader>
				...
				<div className='relative mx-5 aspect-video rounded-xl overflow-hidden ring-1 ring-border bg-black'>
					{imageUrl && (
						<Cropper
							image={imageUrl}
							crop={crop}
				...
				<div className='flex items-center justify-end gap-2 px-5 py-4 border-t border-border'>
					...
					<Button
						type='button'
						size='sm'
						className='bg-primary hover:bg-primary/90 text-primary-foreground rounded-lg px-6 shadow-md shadow-primary/20'
						onClick={onSave}
					>
						{t('common.save')}
					</Button>
